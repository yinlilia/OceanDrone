...
/**
 * Created by yinlili on 2017/12/27.
 */
...
public class NumberProgressView extends View {
     ...
     * 进度条画笔的宽度（dp）
     */
    private int paintProgressWidth = 23;

    /**
     * 文字百分比的字体大小（sp）
     */
    private int paintTextSize =34;

    /**
     * 左侧已完成进度条的颜色
     */
    private int paintLeftColor = 0xff33ffcc;

    /**
     * 右侧未完成进度条的颜色
     */
    private int paintRightColor = 0xffffffff;
    ...
    private void initData() {
        ...
        //设置进度条画笔的宽度
        int paintProgressWidthPx = DensityUtils.dip2px(context, paintProgressWidth);

        //设置百分比文字的尺寸
        int paintTextSizePx = DensityUtils.px2dip(context, paintTextSize);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画左侧已经完成的进度条，长度为从Veiw左端到文字的右侧
        canvas.drawLine(0, viewCenterY, currentMovedLentgh+textWidth, viewCenterY, paintleft);
        ...
        canvas.drawText("电池"+progress + "%", 0, textBottomY, paintText);
    }
