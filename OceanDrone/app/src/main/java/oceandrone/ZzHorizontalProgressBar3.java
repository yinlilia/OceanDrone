 ...
 */
public class ZzHorizontalProgressBar3 extends View {
    ...
    public ZzHorizontalProgressBar3(Context context) {
        super(context);
        init(context, null);
    }

    public ZzHorizontalProgressBar3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ZzHorizontalProgressBar3(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawProgress(Canvas canvas) {
        ...
        canvas.drawText("半径警告"+progress + "%", 0, progressHeight-padding, paintText);
