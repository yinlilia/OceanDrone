...
public class ZzHorizontalProgressBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        gradientFrom = a.getColor(R.styleable.ZzHorizontalProgressBar_zpb_gradient_from, 0xff00ffff);
    ...
    private void drawProgress(Canvas canvas) {
        ...
        canvas.drawText("电池"+progress + "%", 0, progressHeight-padding, paintText);
